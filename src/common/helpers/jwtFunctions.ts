 ...
 */
  ...
  /**
    ...
    * @returns
    */
  public static GenerateTokenInternal(user: User, audienceId: string, _clientId: string): string {
 ...
 * @returns
 */
  public static VerifySimple(jwt: string): JwtPayload | string {

    const virification = verify(jwt, AppConstants.JWT_SECRET);
